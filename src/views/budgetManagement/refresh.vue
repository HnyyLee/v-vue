...
<template>
  <div class="refresh">
    ...
    <div class="center">
      <a-table :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" :rowKey="(record, index) => index" :columns="refreshColumn" :dataSource="houseDataList" bordered class="tab_box" :pagination="false" :locale="{ emptyText: '暂无数据' }" :scroll="{ x: 2400 }">
...
import { refreshColumn } from './js/columns.js'
...
var myConstructionBudgetAllId = 4
export default {
  data () {
    return {
      mythat: this,
