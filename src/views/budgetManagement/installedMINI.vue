...
<template>
  <div class="installedMINI">
    ...
    <div class="center">
      <a-table :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" :rowKey="(record, index) => index" :columns="installedMINIColumn" :dataSource="houseDataList" bordered class="tab_box" :pagination="false" :locale="{ emptyText: '暂无数据' }" :scroll="{ x: 2400 }">
...
import { installedMINIColumn } from './js/columns.js'
...
var myConstructionBudgetAllId = 2
export default {
  data () {
    return {
      mythat: this,
