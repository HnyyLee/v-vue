...
<template>
  <div class="installedPLUS">
    ...
    <div class="center">
      <a-table :rowSelection="{selectedRowKeys: selectedRowKeys, onChange: onSelectChange}" :rowKey="(record, index) => index" :columns="installedPLUSColumn" :dataSource="houseDataList" bordered class="tab_box" :pagination="false" :locale="{ emptyText: '暂无数据' }" :scroll="{ x: 2400 }">
...
import { installedPLUSColumn } from './js/columns.js'
...
var myConstructionBudgetAllId = 3
export default {
  data () {
    return {
      mythat: this,
